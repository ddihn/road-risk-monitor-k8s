...
주요 컴포넌트는 MySQL, Spring Boot API, React 프론트엔드, 그리고 5분 주기로 실행되는 Python 데이터 수집기(CronJob)로 구성되어 있습니다.

---
## ✨ 배포 화면
![모니터링 화면](images/monitoring.png)
![위험도 정보 툴팁](images/detail.png)
![툴팁 내용](images/detail-message.png)
---
...
- 5분마다 외부 공공 API에서 도로 위험도 데이터를 수집하여 DB에 저장하는 Python 수집기용 CronJob
